    ...
    <section className="section container">
      ...
      <div className="_w-[920px] relative">
        <Textarea
          ...
          className={clsx(
            "border-secondary-300 input-text min-h-60 w-full resize-none gap-3 rounded-lg border px-8 pt-2.5 pb-26.5 outline-none hover:outline-none focus:outline-none active:outline-none",
            {
