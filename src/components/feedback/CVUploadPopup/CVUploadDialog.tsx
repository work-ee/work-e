  ...
  return (
    <>
      <Dialog open={open} onOpenChange={(isOpen) => !isOpen && handleDialogClose()}>
        <DialogContent className="w-81 max-w-[unset] gap-4 rounded-xl border-none p-6 md:w-200 md:gap-6 md:rounded-2xl md:p-8">
          <DialogHeader className="h-18 md:h-20.5">
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-6">
            <div
              className={clsx(
                "m-auto h-42 w-43 rounded-xl border p-3 text-center md:h-61 md:w-80.5 md:p-8",
                isUploadDisabled
            ...
            <div className="border-primary-500 relative mx-auto flex h-13 basis-full items-center gap-2 rounded-lg border px-4 py-3.5 md:h-18 md:gap-1">
            ...
            <div className="flex w-full flex-col-reverse gap-4 md:flex-row md:gap-x-6">
              <Button
                variant="secondary"
                className="h-10 w-full items-center justify-center md:order-first md:h-15.5 md:w-89"
                onClick={() => {}}
              >
                Створити CV
              </Button>
              ...
              <Button
                ...
                className="flex h-10 w-full items-center justify-center md:h-15.5 md:w-89"
